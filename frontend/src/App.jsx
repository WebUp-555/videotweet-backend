      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-green-500 rounded-lg flex items-center justify-center transform group-hover:scale-110 transition-transform">
          ...
          <div className="hidden md:flex items-center gap-4">
            {user ? (
              <>
                <Link
                  to="/upload"
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-lg font-medium hover:from-emerald-700 hover:to-green-700 transition-all duration-200 transform hover:scale-105"
                >
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl border border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                    <Link
                      to={`/channel/${user.username}`}
                          className="block px-4 py-2 text-gray-300 hover:bg-emerald-900/30 hover:text-emerald-300 transition-colors rounded-t-lg"
                    >
                      Your Channel
                    </Link>
                    <Link
                      to="/dashboard"
                          className="block px-4 py-2 text-gray-300 hover:bg-emerald-900/30 hover:text-emerald-300 transition-colors"
                    >
                      Dashboard
                    </Link>
                    <button
                      onClick={handleLogout}
                      className="w-full text-left px-4 py-2 text-red-400 hover:bg-emerald-900/30 transition-colors rounded-b-lg"
                    >
                      Logout
                    </button>
                  </div>
              ...
              <>
                <Link
                  to="/login"
                    className="px-4 py-2 text-gray-300 hover:text-emerald-400 transition-colors font-medium"
                >
                  Login
                </Link>
                <Link
                  to="/signup"
                  className="px-6 py-2 bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-lg font-medium hover:from-emerald-700 hover:to-green-700 transition-all duration-200 transform hover:scale-105"
                >
                  Sign Up
                </Link>
              </>
            ...
            <div className="flex flex-col gap-2">
              {!isWelcomePage && (
                <>
                  <Link
                    to="/"
                    className="px-4 py-2 text-gray-300 hover:bg-emerald-900/30 hover:text-emerald-300 rounded-lg transition-colors"
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-red-400 hover:bg-emerald-900/30 rounded-lg transition-colors text-left"
                  >
                    Logout
                  </button>
                </>
